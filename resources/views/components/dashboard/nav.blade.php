        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-between w-100" id="navbarNav">
                ...
                <ul class="navbar-nav align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('user.dashboard', \Auth::user()->username) }}" title="Full Screen">Features</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown profile">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('user.help', \Auth::user()->username) }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <li>
                                <a class="dropdown-item text-danger" href="{{ route('user.settings', \Auth::user()->username) }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
